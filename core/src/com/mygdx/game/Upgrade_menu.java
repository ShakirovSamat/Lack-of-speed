...
public class Upgrade_menu extends  Unit {
    ...
    public Upgrade_menu(int width, int height, int xPosition, int yPosition) {
        ...
        button = new Texture(Gdx.files.internal("garage/button.png"));
        background = new Texture(Gdx.files.internal("garage/upgrade_background.png"));
        buttons[0] = new Button(230,190,xPosition + 30, yPosition + height - 20 - 190, button,"Двигатель");
        buttons[1] = new Button(230,190,xPosition  + width - 30 - 230, yPosition + height - 20 - 190, button,"Трансмисия");
        buttons[2] = new Button(230,190,xPosition + 30, yPosition + 20, button,"Корпус");
        buttons[3] = new Button(230,190,xPosition + width - 30 - 230, yPosition + 20, button,"Сцепление");
